Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "resj_production"
  ...
  config.action_mailer.default_url_options = { :host => "https://reseaujeunesse.ch" }
  config.action_mailer.asset_host = "https://reseaujeunesse.ch"
