class Admin::CardsController < Admin::BaseController
	...
	def attributes
		["name", "description", "street", "npa", "city", "email", "place", "latitude", "longitude", "website", "password_digest", "card_type_id", "current_step", "validated", "tag_names", "responsables_attributes" => ["firstname", "lastname", "email", "_destroy"], "responsable_attributes" => ["firstname", "lastname", "email"], "affiliations_attributes" => ["name", "_destroy"]]
	end
