module ApplicationHelper
	...
	def admin_links
		active = %w[admin/cards admin/card_types admin/pages admin/users admin/affiliations admin/tags admin/responsables admin/ownerships admin/actions admin/parents admin/access_tokens admin/themes admin/resources admin/articles]
